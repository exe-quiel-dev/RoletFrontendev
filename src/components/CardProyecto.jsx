...
const CardProyecto = ({img, tech, info, nombre, link, repo}) => {
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 place-items-center p-0 xl:p-5 pb-8'>
      <a href={link} target='blank' className='opacity-50 hover:opacity-100 transition-all w-full h-full'><img src={img} alt={`Imagen de proyecto ${nombre}`} className='rounded-md lg:rounded-xl w-full h-full' /></a>
